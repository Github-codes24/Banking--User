  ...
  return (
    <>
      <Stack initialRouteName='index'>
        ...
        <Stack.Screen name="splsh" options={{ headerShown : false}} />
        <Stack.Screen name="getstarted" options={{ headerShown : false}} />
        <Stack.Screen name="forgot" options={{ headerShown : false}} />
        <Stack.Screen name="logn" options={{ headerShown : false}} />
        ...
        <Stack.Screen name="accont" options={{  header: () => (<SafeAreaView edges={['top']} style={{backgroundColor:"#fff"}}><CommonHeader title='Accounts'/></SafeAreaView>)}} />
        <Stack.Screen name="acStaement" options={{  header: () => (<SafeAreaView edges={['top']} style={{backgroundColor:"#fff"}}><CommonHeader title='Accounts Statement'/></SafeAreaView>)}} />
        <Stack.Screen name="fdeosite" options={{  header: () => (<SafeAreaView edges={['top']} style={{backgroundColor:"#fff"}}><CommonHeader title='Open Fixed Deposit'/></SafeAreaView>)}} />
        ...
        <Stack.Screen name="qrreen" options={{  header: () => (<SafeAreaView edges={['top']} style={{backgroundColor:"#fff"}}><CommonHeader title='Qr Screen'/></SafeAreaView>)}} />
