        ...
        <>
            <View style={styles.container}>
                ...
                <CommonDropdown
                    ...
                    placeholder="RD Type"
                />
                <CommonInput placeholder="Installment Amount" containerStyle={styles.mb16} />

                <CommonInput placeholder="Enter Deposit Period in Months" containerStyle={styles.mb16} />
